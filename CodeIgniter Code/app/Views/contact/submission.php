            ...
            <div class="container px-5 p-5">
                ...
                <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                    <div class="text-center mb-5">
                        ...
                        <h1 class="fw-bolder">Sugestão de novo termo</h1>
                    </div>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <?php
                                helper('form'); 
                                echo form_open('/emailSubmission')
                            ?>
                                ...
                                <!-- E-mail -->
                                <div class="form-floating mb-3">
                                    <label for="plural">E-mail</label>
                                    <input class="form-control" name="email" id="email" type="text" value="<?php
                                                                                                                if (isset($email)){
                                                                                                                    echo $email;
                                                                                                                } else {
                                                                                                                    echo old('email');
